		...
		>`;return this.state===jo.Paid?ut`<div class="popup-header">${e}</div>`:this.cloud?this.preview?ut`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${an(O.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${an(O.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${an(O.PlusValidate,this.source)}"
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${an(O.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${an(O.PlusSignUp,this.source)}"
				>Start 7-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${an(O.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return ut`<div class="actions">
			${e??ft}
			<gl-button
				appearance="primary"
				density="tight"
				href="${an(O.PlusUpgrade,this.source)}"
