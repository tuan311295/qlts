		...
		>`;return this.state===Gi.Paid?dt`<div class="popup-header">${e}</div>`:this.cloud?this.preview?dt`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${rn(D.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${rn(D.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${rn(D.PlusValidate,this.source)}"
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${rn(D.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${rn(D.PlusSignUp,this.source)}"
				>Start 7-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${rn(D.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return dt`<div class="actions">
			${e??ut}
			<gl-button
				appearance="primary"
				density="tight"
				href="${rn(D.PlusUpgrade,this.source)}"
