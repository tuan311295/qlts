...
`;var ga=Object.defineProperty,fa=Object.getOwnPropertyDescriptor,ma=(e,t,i,o)=>{for(var s,r=o>1?void 0:o?fa(t,i):t,a=e.length-1;a>=0;a--)(s=e[a])&&(r=(o?s(t,i,r):s(r))||r);return o&&r&&ga(t,i,r),r};let ba=class extends lit_element_s{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":_s;switch(this.state){case ca.VerificationRequired:return As`
					<p class="actions">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${va(Vi.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							class="inline"
							appearance="${e}"
							href="${va(Vi.PlusValidate,this.source)}"
				...
				`;case ca.Free:return As`
					<gl-button
						appearance="${e}"
						href="${va(Vi.PlusStartPreviewTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
						...
						<a href="${va(Vi.PlusSignUp,this.source)}"
							>start your free 7-day Pro trial</a
						>
						or
						<a href="${va(Vi.PlusLogin,this.source)}" title="Sign In">sign in</a>.
					</p>
				`;case ca.FreePreviewTrialExpired:return As`
					<gl-button
						appearance="${e}"
						href="${va(Vi.PlusSignUp,this.source)}"
				...
				`;case ca.FreePlusTrialExpired:return As` <gl-button
						appearance="${e}"
						href="${va(Vi.PlusUpgrade,this.source)}"
					...
					<gl-button
						appearance="${e}"
						href="${va(Vi.PlusReactivateProTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
		...
		>`;return this.state===ca.Paid?As`<div class="popup-header">${e}</div>`:this.cloud?this.preview?As`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${Ea(Vi.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Ea(Vi.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${Ea(Vi.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Ea(Vi.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${Ea(Vi.PlusSignUp,this.source)}"
				>Start 7-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${Ea(Vi.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return As`<div class="actions">
			${e??_s}
			<gl-button
				appearance="primary"
				density="tight"
				href="${Ea(Vi.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
