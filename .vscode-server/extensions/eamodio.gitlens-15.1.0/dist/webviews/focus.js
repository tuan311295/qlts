...
`;var dr=Object.defineProperty,pr=Object.getOwnPropertyDescriptor,hr=(e,t,o,i)=>{for(var n,r=i>1?void 0:i?pr(t,o):t,a=e.length-1;a>=0;a--)(n=e[a])&&(r=(i?n(t,o,r):n(r))||r);return i&&r&&dr(t,o,r),r};let ur=class extends lit_element_s{firstUpdated(){"alert"===this.appearance&&queueMicrotask((()=>this.button.focus()))}render(){if(null==this.state)return void(this.hidden=!0);this.hidden=!1;const e="alert"===(this.appearance??"alert")?"alert":Yt;switch(this.state){case rr.VerificationRequired:return Qt`
					<p class="actions">
						<gl-button
							class="inline"
							appearance="${e}"
							href="${gr(L.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							class="inline"
							appearance="${e}"
							href="${gr(L.PlusValidate,this.source)}"
				...
				`;case rr.Free:return Qt`
					<gl-button
						appearance="${e}"
						href="${gr(L.PlusStartPreviewTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
						...
						<a href="${gr(L.PlusSignUp,this.source)}"
							>start your free 7-day Pro trial</a
						>
						or
						<a href="${gr(L.PlusLogin,this.source)}" title="Sign In">sign in</a>.
					</p>
				`;case rr.FreePreviewTrialExpired:return Qt`
					<gl-button
						appearance="${e}"
						href="${gr(L.PlusSignUp,this.source)}"
				...
				`;case rr.FreePlusTrialExpired:return Qt` <gl-button
						appearance="${e}"
						href="${gr(L.PlusUpgrade,this.source)}"
					...
					<gl-button
						appearance="${e}"
						href="${gr(L.PlusReactivateProTrial,this.source)}"
						>Continue</gl-button
					>
					<p>
		...
		>`;return this.state===rr.Paid?Qt`<div class="popup-header">${e}</div>`:this.cloud?this.preview?Qt`<div class="popup-header">
			...
			${e}<span class="popup-subtitle"> Requires a paid plan for use on privately-hosted repos</span>
					...
					<gl-tooltip hoist content="Show Account view">
						<a href="${Pr(L.ShowAccountView,void 0)}"
					...
					<div class="actions">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Pr(L.PlusResendVerification,this.source)}"
							>Resend Email</gl-button
						>
						<gl-button
							appearance="secondary"
							density="tight"
							href="${Pr(L.PlusValidate,this.source)}"
							><code-icon icon="refresh"></code-icon
						></gl-button>
					...
					<div class="actions center">
						<gl-button
							appearance="primary"
							density="tight"
							href="${Pr(L.PlusReactivateProTrial,this.source)}"
			...
			<gl-button
				appearance="primary"
				density="tight"
				href="${Pr(L.PlusSignUp,this.source)}"
				>Start 7-day Pro Trial</gl-button
			>
			&nbsp;or <a href="${Pr(L.PlusLogin,this.source)}" title="Sign In">sign in</a>
		</div>`}renderUpgradeActions(e){return Qt`<div class="actions">
			${e??Yt}
			<gl-button
				appearance="primary"
				density="tight"
				href="${Pr(L.PlusUpgrade,this.source)}"
				>Upgrade to Pro</gl-button
			>
